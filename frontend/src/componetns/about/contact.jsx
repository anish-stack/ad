        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              We'd love to hear from you! If you have any inquiries, suggestions, or simply want to connect, feel free to reach out to us.
              </p>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-body-color text-base">+91  99589 69632</p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div
                ...
                <div className="w-full">
                  ...
                  <p className="text-body-color text-base">info@DoSomething.com</p>
                </div>
              </div>
            </div>
          </div>
